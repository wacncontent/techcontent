...
若要查看这篇文章的经典版，请参阅[适用于 SQL Server 经典 VM 的 SQL Server 代理扩展](./virtual-machines-windows-classic-sql-server-agent-extension.md)。
...
| **Azure 密钥保管库集成** |可让你在 SQL Server VM 上自动安装和配置 Azure 密匙保管库。有关详细信息，请参阅 [为 Azure VM 上的 SQL Server 配置 Azure Key Vault 集成 \(Resource Manager\)](./virtual-machines-windows-ps-sql-keyvault.md)。 |

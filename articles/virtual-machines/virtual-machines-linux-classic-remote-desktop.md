...
> [!NOTE]你必须已有运行 Linux 的 Azure VM。若要创建和设置 Linux VM，请参阅 [Azure Linux VM 教程](./virtual-machines-linux-classic-createportal.md)。
...
> [!NOTE]在下面的命令中，使用你正在使用的版本更新 OpenSUSE 版本，下面是 `OpenSUSE 13.2` 的一个示例命令。

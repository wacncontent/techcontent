...
| 使用 Windows 导入/导出服务运送硬盘驱动器 | SQL Server 2005 或更高版本 | SQL Server 2005 或更高版本 | [Azure VM 存储限制](../azure-subscription-service-limits.md) | Azure 中国当前尚不支持“Windows 导入/导出服务”|

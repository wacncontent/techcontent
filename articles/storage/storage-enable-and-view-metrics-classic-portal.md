---
title: 在 Azure 门户预览中启用存储度量值 | Azure
...
有关如何配置 Azure PowerShell cmdlet 以使用 Azure 订阅以及如何选择要使用的默认存储帐户的信息，请参阅：[如何安装和配置 Azure PowerShell](../powershell-install-configure.md)。

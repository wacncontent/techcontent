...
转到[创建和部署 blink 应用程序](./iot-hub-raspberry-pi-kit-c-lesson1-deploy-blink-app.md)。
...
转到[运行示例应用程序，以便发送从设备到云的消息](./iot-hub-raspberry-pi-kit-c-lesson3-run-azure-blink.md)。
...
转到[读取保存在 Azure 存储中的消息](./iot-hub-raspberry-pi-kit-c-lesson3-read-table-storage.md)。
...
转到[运行示例应用程序，接收从云到设备的消息](./iot-hub-raspberry-pi-kit-c-lesson4-send-cloud-to-device-messages.md)。
...
转到[可选部分：更改 LED 的开关行为](./iot-hub-raspberry-pi-kit-c-lesson4-change-led-behavior.md)。

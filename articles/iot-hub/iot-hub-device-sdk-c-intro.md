---
title: 使用适用于 C 语言的 Azure IoT 设备 SDK | Azure
...
许多平台已对 SDK 进行了测试（有关详细信息，请参阅[平台和兼容性列表](./iot-hub-tested-configurations.md)）。尽管本文包含的是在 Windows 平台上运行的示例代码演示，但请记住，本文所述的代码在各种支持的平台上都完全相同。

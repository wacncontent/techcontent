...
本主题提供了有关如何使用 Azure Web 作业和 Azure WebJobs SDK 的文档资源的链接。通过使用 Azure Web 作业，可以方便地在[应用服务 Web 应用、API 应用或移动应用](./index.md)的上下文中将脚本或程序作为后台进程运行。你可以上载和运行可执行文件，例如 cmd、bat、exe (.NET)、ps1、sh、php、py、js 和 jar。这些程序将按计划 (cron) 或者连续地以 Web 作业的形式运行。
...
* [远程调试 Web 作业](./web-sites-dotnet-troubleshoot-visual-studio.md#remotedebugwj)
...
* [监视、诊断和排查 Azure 存储空间问题](../storage/storage-monitoring-diagnosing-troubleshooting.md)

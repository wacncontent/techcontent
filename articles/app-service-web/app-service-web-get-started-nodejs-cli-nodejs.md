---
title: 在 5 分钟内将 Node.js Web 应用部署到 Azure | Azure
...
## 后续步骤
[创建、配置 Node.js Express Web 应用，并将其部署到 Azure](./app-service-web-nodejs-get-started-cli-nodejs.md)。通过学习本教程，可以了解在 Azure 中运行 Node.js Web 应用所需的基本技能，如：

...
>[!NOTE] 适用于 Office 2013 客户端的现代身份验证
>
...
>[!WARNING]  在客户端与同时与本地和云自动发现终结点通信的混合环境中，应用密码不起作用。
>

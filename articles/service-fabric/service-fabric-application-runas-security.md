...
以下示例演示名为 TestUser 的 Active Directory 用户，其域密码已使用名为 MyCert 的证书加密。可以使用 `Invoke-ServiceFabricEncryptText` PowerShell 命令创建机密加密文本。请参阅[管理 Service Fabric 应用程序中的机密](./service-fabric-application-secret-management.md)获取详细信息。

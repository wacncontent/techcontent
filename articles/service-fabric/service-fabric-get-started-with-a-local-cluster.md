...
> [!NOTE]
> 本文假设用户已[设置开发环境](./service-fabric-get-started.md)。
...
## 部署应用程序
Service Fabric SDK 包含一组丰富的框架以及用于创建应用程序的开发人员工具。如果有兴趣了解如何在 Visual Studio 中创建应用程序，请参阅[在 Visual Studio 中创建你的第一个 Service Fabric 应用程序](./service-fabric-create-your-first-application-in-visual-studio.md)。

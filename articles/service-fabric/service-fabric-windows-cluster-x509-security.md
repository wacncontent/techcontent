...
成功运行安全且独立的 Windows 群集并设置可连接到该群集的、经过身份验证的客户端之后，即可按照[使用 PowerShell 连接到安全群集](./service-fabric-connect-to-secure-cluster.md#connectsecurecluster)部分的步骤连接到该群集。例如：

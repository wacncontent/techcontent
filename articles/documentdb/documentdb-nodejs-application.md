...
> [!TIP] 本 Node.js 教程假定你之前有使用 Node.js 和 Azure 网站的经验。
...
4. 将以下代码复制到 **docdbUtils.js** 中
    ...
    > [!TIP] createCollection 采用一个用以指定集合 Offer 类型的可选 requestOptions 参数。如果没有提供任何 requestOptions.offerType 值，则将使用默认 Offer 类型创建集合。
    >

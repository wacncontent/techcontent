...
### DocumentDB 的存储限制有哪些？
对于集合可以存储在 DocumentDB 中的数据总量并没有任何限制。如果想在单个集合中存储超过 250 GB 的数据，请[联系支持人员](./documentdb-increase-limits.md)提高帐户配额。

### DocumentDB 的吞吐量限制有哪些？
如果工作负荷可以大致平均分配给足够大量的分区键，则在 DocumentDB 中集合可以支持的吞吐量总量没有限制。如果希望每个集合或帐户每秒的请求单位数超过 250,000 个，请[联系支持人员](./documentdb-increase-limits.md)提高帐户配额。

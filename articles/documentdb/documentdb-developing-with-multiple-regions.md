...
- [How throughput works with multiple regions（多个区域中的吞吐量工作原理）](./documentdb-manage.md)
- [Add regions using the Azure portal（使用 Azure 门户预览添加区域）](./documentdb-portal-global-replication.md)

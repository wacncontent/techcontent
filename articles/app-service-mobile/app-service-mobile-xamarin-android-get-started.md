...
* 有效的 Azure 帐户。如果没有帐户，可以注册 Azure 试用版并获取最多 10 个免费移动应用。有关详细信息，请参阅 [Azure 试用](https://www.azure.cn/pricing/1rmb-trial/)。
...
* [向应用添加脱机同步功能](./app-service-mobile-xamarin-android-get-started-offline-data.md)

...
- [将 Hyper-V VM 复制到 Azure（不使用 VMM）](./site-recovery-hyper-v-site-to-azure.md#before-you-start)
- [将 Hyper-V VM 复制到 Azure（使用 VMM）](./site-recovery-vmm-to-azure.md#before-you-start)
...
要复制到 Azure 的虚拟机应符合 [Azure 要求](./site-recovery-best-practices.md#virtual-machines)。

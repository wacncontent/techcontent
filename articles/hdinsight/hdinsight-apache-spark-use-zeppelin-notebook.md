...
---
title: 为 HDInsight Linux 上的 Apache Spark 群集安装 Zeppelin 笔记本 | Azure
...
有关如何在 HDInsight .NET SDK 中运行脚本操作安装 Zeppelin 的说明，请参阅 [Customize HDInsight clusters using Script Action](./hdinsight-hadoop-customize-cluster-linux.md#use-a-script-action-during-cluster-creation)（使用脚本操作自定义 HDInsight 群集）。必须对该文章中的说明做出一些更改。

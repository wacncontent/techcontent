...
> [!NOTE]HDInsight 2.1 和 3.0 群集均运行在 Azure 来宾 OS [系列 4](../cloud-services/cloud-services-guestos-update-matrix.md) 上，该系列使用 64 位版本的 Windows Server 2012 R2 并支持 .NET Framework 4.0、4.5 和 4.5.1。

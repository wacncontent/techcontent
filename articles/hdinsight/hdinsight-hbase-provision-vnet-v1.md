...
5. 输入要用于此群集的 Hadoop 用户名和密码，然后单击右侧按钮。
    ...
    <tr><td>为群集启用远程桌面</td>
        <td>在设置后，选中此复选框，以为可远程连接到群集节点的远程桌面用户指定用户名、密码和到期日期。稍后，你还可以在设置了群集后启用远程桌面。有关说明，请参阅<a href="./hdinsight-administer-use-management-portal-v1.md#rdp" target="_blank">使用 RDP 连接到 HDInsight 群集</a>。</td></tr>
    </table>
...
- [开始使用 HDInsight](./hdinsight-hadoop-tutorial-get-started-windows-v1.md)
- [在 HDInsight 中配置 HBase 复制](./hdinsight-hbase-geo-replication.md)
- [在 HDInsight 中设置 Hadoop 群集](./hdinsight-provision-clusters-v1.md)
- [开始在 HDInsight 中将 HBase 与 Hadoop 配合使用](./hdinsight-hbase-tutorial-get-started-v1.md)
...
[hdinsight-admin-portal]: ./hdinsight-administer-use-management-portal-v1.md#rdp

...
HDInsight 上的 Apache Spark 群集包含 Anaconda 库，还包括适用于机器学习的 **scikit-learn** 库。该库还包含用于直接从 Jupyter 笔记本生成应用程序示例的各种数据集。有关使用 scikit-learn 库的示例，请参阅 [http://scikit-learn.org/stable/auto_examples/index.html](http://scikit-learn.org/stable/auto_examples/index.html)。
...
* [使用 Scala 创建独立应用程序](./hdinsight-apache-spark-create-standalone-application.md)
...
* [可用于 HDInsight 的 Spark 群集中 Jupyter 笔记本的内核](./hdinsight-apache-spark-jupyter-notebook-kernels.md)

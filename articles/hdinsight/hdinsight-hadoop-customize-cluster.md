...
---
title: 使用脚本操作自定义 HDInsight 群集 | Microsoft Azure
...
1. 使用“自定义创建”选项开始预配群集，如[使用自定义选项预配群集](./hdinsight-provision-clusters.md)中所述。 
...
Microsoft Azure HDInsight 服务是一个灵活的平台，可使用围绕 Hadoop 形成的开源技术生态系统，在云中生成大数据应用程序。Microsoft Azure 可为开源技术提供一般级别支持，如 <a href="https://www.azure.cn/support/faq/" target="_blank">Azure 支持常见问题网站</a>上的**支持范围**节中所述。HDInsight 服务可为某些组件提供额外级别的支持，如下所述。

...
---
title: 在 HDInsight 上将 Apache Spark 与 Kafka 配合使用 | Azure
...
* [HDInsight 上的 Apache Kafka 入门](./hdinsight-apache-kafka-get-started.md)
* [使用 MirrorMaker 在 HDInsight 上创建 Kafka 的副本](./hdinsight-apache-kafka-mirroring.md)

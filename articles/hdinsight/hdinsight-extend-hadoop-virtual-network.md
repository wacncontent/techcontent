...
* [在 HDInsight 中设置 Hadoop 群集](./hdinsight-provision-clusters-v1.md) - 提供有关预配 Hadoop 群集的信息，包括有关使用 Azure 虚拟网络的信息。
* [将 Sqoop 与 HDinsight 中的 Hadoop 配合使用](./hdinsight-use-sqoop.md) - 提供有关使用 Sqoop 通过虚拟网络传输 SQL Server 数据的信息。

---
title: 添加自定义域名并设置 Azure Active Directory 的联合登录 | Azure
...
如果你不需要且并不打算部署 AD FS 或另一个联合服务器，请遵循以下说明：[将自定义域名添加到 Azure Active Directory](./active-directory-add-domain.md)。

...
>[!NOTE]
> 所有成本随时会变化。上表反映当前定价，不包括任何当前可用的促销特价。有关 Azure 的最新价格信息，请参阅 [Azure 定价](http://www.windowsazure.cn/pricing/overview/)页。有关服务总线价格的详细信息，请参阅[服务总线定价](https://www.azure.cn/pricing/details/messaging/)。

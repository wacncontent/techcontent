...
可在服务总线[中继](./service-bus-fundamentals-hybrid-solutions.md#relays)、[队列](./service-bus-fundamentals-hybrid-solutions.md#queues)、[主题](./service-bus-fundamentals-hybrid-solutions.md#topics)和事件中心上配置共享访问签名授权规则。

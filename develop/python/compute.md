...
<h3>教程：<a href="../../articles/app-service-web/web-sites-python-configure.md">使用 Azure 网站配置 Python</a></h3>
...
<h3>教程：<a href="../../articles/app-service-web/web-sites-python-create-deploy-django-app.md">创建并部署 Django 网站</a></h3>
<p>了解如何创建在 Django Python Web 框架中编写的网站并将该网站部署到 Azure。你将学习打包 Python 运行时、所需的库（包括 Django）和你的应用程序，然后在 Azure 上托管网站的基础知识。</p>
<!--
<h3>Tutorial: <a href="../../articles/app-service-web/web-sites-python-create-deploy-bottle-app.md">Bottle using Git from Windows, Mac, Linux</a></h3>
...
<h3>Tutorial: <a href="../../articles/app-service-web/web-sites-python-create-deploy-flask-app.md">Flask using Git from Windows, Mac, Linux</a></h3>
...
<h3>Tutorial: <a href="../../articles/app-service-web/web-sites-python-ptvs-django-mysql.md">Django and MySQL with PTVS 2.1</a></h3>
...
<h3>Tutorial: <a href="../../articles/app-service-web/web-sites-python-ptvs-django-sql.md">Django and SQL 数据库 with PTVS 2.1</a></h3>
...
<h3>Tutorial: <a href="../../articles/app-service-web/web-sites-python-ptvs-bottle-table-storage.md">Bottle and Azure Table Storage with PTVS 2.1</a></h3>
...
<h3>Tutorial: <a href="../../articles/app-service-web/web-sites-python-ptvs-flask-table-storage.md">Flask and Azure Table Storage with PTVS 2.1</a></h3>
...
<h3>教程：<a href="../../articles/cloud-services/cloud-services-python-ptvs.md">使用 Python Tools for Visual Studio 2.0 创建 Django 应用程序</a></h3>
...
<h3>功能指南：<a href="../../articles/cloud-services/cloud-services-python-how-to-use-service-management.md">服务管理</a></h3>
<p>本指南演示如何通过使用 Azure SDK for Python 中的 ServiceManagementService 类,以编程方式执行 Python 的常见服务管理任务。</p>
<h2 id="header-2">虚拟机</h2>
<h3>教程：<a href="../../articles/virtual-machines/virtual-machines-linux-python-django-web-app.md">Linux 虚拟机上的 Django Hello World Web 应用程序</a></h3>
...
<h3>教程：<a href="../../articles/virtual-machines/virtual-machines-windows-classic-python-django-web-app.md">Windows 虚拟机上的 Django Hello World Web 应用程序</a></h3>
<p>了解如何使用 Windows Server 虚拟机在 Azure 上托管基于 Django 的网站。你将了解如何设置 Azure 虚拟机以托管 Django，以及如何从 Windows 创建新的 Django 应用程序。</p>
<h3>教程：<a href="../../articles/virtual-machines/virtual-machines-linux-jupyter-notebook.md">Azure 上的 iPython Notebook</a></h3>

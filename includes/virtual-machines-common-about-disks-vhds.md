...
>[!WARNING]
> 不要在临时磁盘上存储数据。该磁盘为应用程序和进程提供临时存储空间，只用于存储页面文件或交换文件等数据。若要将此磁盘重新映射到 Windows 虚拟机的其他驱动器号，请参阅[更改 Windows 临时磁盘的驱动器号](../articles/virtual-machines/virtual-machines-windows-classic-change-drive-letter.md)。
...
>[!NOTE]
> 有关虚拟机容量的更多详细信息，请参阅 [Linux 虚拟机的大小](../articles/virtual-machines/virtual-machines-linux-sizes.md)或 [Windows 虚拟机的大小](../articles/virtual-machines/virtual-machines-windows-sizes.md)。
...
>[!WARNING]
> 如果你从存储空间删除了源 .vhd 文件或删除了你的存储帐户，Azure.cn 无法为你恢复数据。

...
> [!NOTE] 设备克隆旨在执行同步以及查询设备的配置和条件。可在[了解设备克隆][lnk-twins]中找到设备克隆适用情况的详细信息。
...
> [!NOTE] 当前，只能从使用 MQTT 协议连接到 IoT 中心的设备访问设备克隆。有关如何转换现有设备应用以使用 MQTT 的说明，请参阅 [MQTT 支持][lnk-devguide-mqtt]一文。

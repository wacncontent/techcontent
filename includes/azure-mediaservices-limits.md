>[!NOTE]
对于不固定的资源，可以通过[在线提交工单](https://www.azure.cn/support/support-ticket-form/?l=zh-cn)的方式请求提高配额。**请勿**尝试通过创建更多 Azure 媒体服务帐户的方式来提高配额限制。
...
从 2017 年 4 月 1 日开始，用户帐户中任何超过 90 天的作业记录及其关联的任务记录都会被系统自动删除，即使记录总数低于最大配额。若需存档作业/任务信息，可使用[此处](../articles/media-services/media-services-dotnet-manage-entities.md)所述代码。
